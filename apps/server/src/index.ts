...
import { importCoinspotRoute } from './routes/importCoinspot.js';
import { cryptoCgtRoute } from './routes/cryptoCgt.js';
import { cryptoTradesRoute } from './routes/cryptoTrades.js';
...
app.route('/api/import/coinspot', importCoinspotRoute);
app.route('/api/crypto-cgt', cryptoCgtRoute);
app.route('/api/crypto-trades', cryptoTradesRoute);
